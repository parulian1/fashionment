...
hiConfig={sensitivity:3,interval:150,timeout:100,over:function(){$('#row_pic2').animate({top:"0px"},300)
$('#row_pic3').animate({top:"0px"},300)
$('#row_pic4').animate({top:"0px"},300)
if(a!=1){$('.flash_picture').animate({"height":"toggle","opacity":"toggle"},{"duration":"fast"})
$('#row_pic1').animate({top:"-30px"},300)}},out:function(){if(a!=1){var get_flash_url=$("#row_pic1 input").val()
var MEDIA_URL="/media/"
...
hiConfig={sensitivity:3,interval:150,timeout:100,over:function(){$('#row_pic1').animate({top:"0px"},300)
$('#row_pic3').animate({top:"0px"},300)
$('#row_pic4').animate({top:"0px"},300)
if(a!=2){$('.flash_picture').animate({"height":"toggle","opacity":"toggle"},{"duration":"fast"})
$('#row_pic2').animate({top:"-30px"},300)}},out:function(){if(a!=2){var get_flash_url=$("#row_pic2 input").val()
var MEDIA_URL="/media/"
var src_flash_picture=MEDIA_URL+get_flash_url
$('.flash_picture').animate({"height":"toggle","opacity":"toggle"},{"duration":"slow"}).attr('src',src_flash_picture)
...
$('#row_pic3').animate({top:"-30px"},300)}},out:function(){if(a!=3){var get_flash_url=$("#row_pic3 input").val()
var MEDIA_URL="/media/"
var src_flash_picture=MEDIA_URL+get_flash_url
$('.flash_picture').animate({"height":"toggle","opacity":"toggle"},{"duration":"slow"}).attr('src',src_flash_picture)
...
$('#row_pic4').animate({top:"-30px"},300)}},out:function(){if(a!=4){var get_flash_url=$("#row_pic4 input").val()
var MEDIA_URL="/media/"
var src_flash_picture=MEDIA_URL+get_flash_url
$('.flash_picture').animate({"height":"toggle","opacity":"toggle"},{"duration":"slow"}).attr('src',src_flash_picture)
