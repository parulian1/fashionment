...
$('.ads_for_index li').hover(function(e){console.log('1')
var child=$(this).children().children()
child.stop().animate({top:'-30px'},300);var get_flash_url=$(this).children().children().children(".flash_input").val()
var MEDIA_URL="/media/"
var src_flash_picture=MEDIA_URL+get_flash_url
$('.flash_picture').stop().animate({"height":"toggle","opacity":"toggle"},{"duration":300}).attr('src',src_flash_picture)},function(){console.log('2')
var child=$(this).children().children()
var get_flash_url=$(this).children().children().children(".flash_input").val()
var MEDIA_URL="/media/"
var src_flash_picture=MEDIA_URL+get_flash_url
child.stop().animate({top:'0px'},300);$('.flash_picture').attr('src',src_flash_picture)});}}
