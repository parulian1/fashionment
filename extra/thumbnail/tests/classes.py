...
from extra.thumbnail.base import Thumbnail
from extra.thumbnail.main import DjangoThumbnail, get_thumbnail_setting
from extra.thumbnail.processors import dynamic_import, get_valid_options
from extra.thumbnail.tests.base import BaseTest, RELATIVE_PIC_NAME, PIC_NAME,\
    THUMB_NAME, PIC_SIZE

settings.DEFAULT_THUMBNAIL_OPTIONS = {}
...
class ThumbnailTest(BaseTest):
    ...
    def testRGBA(self):
        ...
        rgba_pic_name = os.path.join(settings.MEDIA_ROOT,
                                     'extra-thumbnail-test_rgba_source.png')
        ...
        rgba_thumb_name = os.path.join(settings.MEDIA_ROOT,
                                       'extra-thumbnail-test_rgba_dest.png')
...
class DjangoThumbnailTest(BaseTest):
    ...
    def testFilenameGeneration(self):
        ...
        # Different basedir
        basedir = 'extra-thumbnail-test-basedir'
    ...
    def testUnicodeName(self):
        unicode_name = 'extra-thumbnail-ążśź_source.jpg'
