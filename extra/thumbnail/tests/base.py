...
def get_default_settings():
    from extra.thumbnail import defaults
    def_settings = {}
...
RELATIVE_PIC_NAME = "extra-thumbnail-test_source.jpg"
PIC_NAME = os.path.join(settings.MEDIA_ROOT, RELATIVE_PIC_NAME)
THUMB_NAME = os.path.join(settings.MEDIA_ROOT, "extra-thumbnail-test_%02d.jpg")
PIC_SIZE = (800, 600)
