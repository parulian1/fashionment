...
from extra.thumbnail.processors import get_valid_options, dynamic_import
...
class Thumbnail(object):
    ...
    def __init__(self, source, requested_size, opts=None, quality=85,
        ...
        settings_opts = getattr(settings,'DEFAULT_THUMBNAIL_OPTIONS',{}) 
        opts = dict(settings_opts,**opts)
        self.opts = opts
